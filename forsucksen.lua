...
local function teleportToRandomServer()
	...
	local TeleportMaxRetry = 5
	local TeleportRetryDelay = 2
	...
	MakeNotif(
		"Serverhop Failed",
		"All attempts to find and teleport to a server failed.",
		5,
		Color3.fromRGB(255, 0, 0)
	)
end
...
local desiredSprintMultiplier = 6
    ...
    while true do
        pcall(function()
            if game.Players.LocalPlayer and game.Players.LocalPlayer.Character then
                print("Attempting to fire UseActorAbility: Ghostburger")
